...
<html lang="en">
    <head>
        ...
        <!-- <link rel="shortcut icon" href="{{asset('assets/frontend/images')}}/star.png" type="favicon/ico" /> -->
        ...
        <style>
            ...
            {
                background: url({{ asset('storage/sliders/'.$slider->image) }});
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item" id="{{ $item->category->slug }}">
                                    ...
                                    <a href="#">
                                        <img src="{{asset('storage/items/'.$item->image)}}" class="img-responsive" alt="Food" style="width:320px; hieght:370px">
                                    ...
                                    <h2 class="white">TK {{ $item->price-$item->offered_price  }}</h2>
                                </li>
                                @endforeach
                            </ul>
        ...
        <section id="have-a-look" class="have-a-look hidden-xs">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('assets/frontend/images')}}/icons/food_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="menu-gallery" style="width: 50%; float:left;">
                            <div class="flexslider-container">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu1.png" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu2.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu3.png" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu4.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu5.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu6.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu7.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu8.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu9.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu10.jpg" />
                                        </li>
                                        <li>
                                            <img src="{{asset('assets/frontend/images')}}/menu-gallery/menu11.jpg" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2015 <a href="#">Website Link.</a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a> Developed by <a href="#"> Sham</a>
                            </p>
                        </div>
                    </div>
                </div>
